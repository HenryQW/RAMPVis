...
The view provides the functionality to sort the parameters based on their values and can be dynamically updated by brushing the parallel coordinates plot for input parameters (\Cref{fig:teaser}A).
