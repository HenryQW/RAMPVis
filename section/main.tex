...
\begin{enumerate}
    ...
    \item The modelers requested all the simulation results be displayed in \Cref{fig:1st-line}, with the current one highlighted. We implemented this as shown in \Cref{fig:teaser}D.
