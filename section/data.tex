...
The model accepts 16 input parameters (see \Cref{tab:input_params}), a random seed facilitates the generation of 160 distinct sets of configurations for these input parameters.
